            ...
            <span class="flex">
              ...
              <div :class="selectedUsers.length > 0 ? 'tooltip' : null" :data-tip="(selectedUsersHasLocked ? 'Unlock ' : 'Lock ') + selectedUsers.length + ' users'">
                <button
                  ...
                  class="btn btn-ghost disabled:bg-transparent" :disabled="selectedUsers.length == 0"
                >
              ...
              <div :class="selectedUsers.length > 0 ? 'tooltip' : null" :data-tip="'Reset ' + selectedUsers.length + ' users MFA'">
                <button @click="updateUser(selectedUsers, UserEditActions.ResetMFA)" class="btn btn-ghost disabled:bg-transparent" :disabled="selectedUsers.length == 0">
              ...
              <div :class="selectedUsers.length > 0 ? 'tooltip' : null" :data-tip="'Delete ' + selectedUsers.length + ' users'">
                <ConfirmModal @on-confirm="() => tryDeleteUsers(selectedUsers)">
                  <button class="btn btn-ghost disabled:bg-transparent" :disabled="selectedUsers.length == 0">Bulk Delete<font-awesome-icon :icon="Icons.Delete" /></button>
                </ConfirmModal>
              </div>
            </span>
