            ...
            <span class="flex">
              ...
              <div :class="selectedDevices.length > 0 ? 'tooltip' : null"
                ...
                :disabled="selectedDevices.length == 0"
                  ...
                  class="btn btn-ghost disabled:bg-transparent">{{ selectedDevicesHasLocked ? 'Unlock' : 'Lock' }}
              ...
              <div :class="selectedDevices.length > 0 ? 'tooltip' : null" :data-tip="'Delete ' + selectedDevices.length + ' devices'">
                <ConfirmModal @on-confirm="() => tryDeleteDevices(selectedDevices)">
                  <button :disabled="selectedDevices.length == 0" class="btn btn-ghost disabled:bg-transparent">Bulk Delete<font-awesome-icon
